            ...
            <div style={styles.modalBody}>
              <div style={styles.detailsSection}>
                ...
                <div style={styles.detailsGrid}>
                  ...
                  <div style={styles.detailItem}>
                    <strong style={{ color: 'var(--text-main)' }}>Manager:</strong> {selectedProject.manager_name || "Unassigned"}
                  </div>
                  <div style={styles.detailItem}>
...
const styles = {
  ...
  emptyState: { padding: '80px', textAlign: 'center', color: 'var(--text-secondary)', gridColumn: '1 / -1' },
  ...
  modal: { background: 'var(--bg-surface)', borderRadius: '16px', width: '100%', maxWidth: '600px', maxHeight: '90vh', overflow: 'auto', boxShadow: 'var(--shadow-lg)' },
