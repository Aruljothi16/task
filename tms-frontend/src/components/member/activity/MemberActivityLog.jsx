...
const MemberActivityLog = () => {
    ...
    const getActionIcon = (actionType) => {
        const iconMap = {
            ...
            user_updated: <User size={16} />,
            user_deleted: <UserMinus size={16} />,
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.header}>
                <div>
                    <h1 style={styles.title}>My Activity Log</h1>
                    <p style={styles.subtitle}>Track your recent activities and changes</p>
                </div>
                            ...
                            <div style={styles.activityContent}>
                                <div style={styles.activityHeader}>
                                    <div style={styles.activityDescription}>
                                        <span style={styles.userName}>{activity.user_name || 'You'}</span>
...
const styles = {
    ...
    activityCard: { background: 'var(--bg-surface)', borderRadius: '16px', padding: '20px', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--border-light)', display: 'flex', gap: '20px', alignItems: 'flex-start' },
    ...
    descriptionText: { color: 'var(--text-main)', lineHeight: '1.5' },
